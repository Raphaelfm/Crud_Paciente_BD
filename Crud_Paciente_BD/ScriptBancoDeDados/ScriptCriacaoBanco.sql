...
-- Formando estrutura do banco de dados para basedados_pacientes
DROP DATABASE IF EXISTS basedados_pacientes;
CREATE DATABASE IF NOT EXISTS basedados_pacientes; 
